...
@Component({
  ...
  template: `
    ...
    <div id="sidebar" class="sidebar py-3">
      <div class="text-gray-400 text-uppercase px-3 px-lg-4 py-0 font-weight-bold small headings-font-family">MAIN</div>
      <ul class="sidebar-menu list-unstyled">
        ...
        <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#pages" aria-expanded="false"
            aria-controls="pages" class="sidebar-link text-muted"><i class="o-wireframe-1 mr-3 text-gray"></i><span>Pages</span></a>
          <div id="pages" class="collapse">
            <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
              <li class="sidebar-list-item"><a href="#" router-link='/eqMast' class="sidebar-link text-muted pl-lg-5">Equipment
                  Master</a></li>
      ...
      <div class="text-gray-400 text-uppercase px-3 px-lg-4 py-0 font-weight-bold small headings-font-family">FAVIRATES</div>
      <ul class="sidebar-menu list-unstyled">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 text-center text-md-left text-primary">
          <p class="mb-2 mb-md-0">Micropro Software Solutions Pvt. Ltd. &copy; 2018-2020</p>
        </div>
        <div class="col-md-6 text-center text-md-right text-gray-400">
          <p class="mb-0">Design by <a href="https://www.microproindia.com" class="external text-gray-400">Micropro</a></p>
        </div>
      </div>
    </div>
  </footer>
...
<button type="button" data-toggle="collapse" data-target="#style-switch" id="style-switch-button" class="btn btn-primary btn-sm d-none d-lg-inline-block p-3 collapsed"
  aria-expanded="false">
